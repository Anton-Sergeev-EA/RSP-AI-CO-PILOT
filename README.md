# RSP AI CO-PILOT
### Предиктивная диагностика оборудования и RAG-ассистент диспетчера для Ракурс (RSP SCADA/HMI)

Технический прототип (PoC) для позиции руководителя отдела инноваций и IT-разработок.
...
SCADA/HMI чат-копайлот: диспетчер может спросить на естественном языке «что с ГА-3?»
...
## 2. Зачем это компании (для питча руководству)
...
## 7. Дорожная карта после демо (для обсуждения с руководством)
